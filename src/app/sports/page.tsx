...
export default function Sports() {
  return (
    /* Page Rendering to the button show more */
    <main
    ...
    >
      ...
      <nav className="flex">
        <div className="m-4 relative right-[41%] top-5">
          <Link href="#" className="text-white m-4 relative top-4 font-bold">
            Sports
          </Link>
      ...
      {/*  Images section Starts from here*/}
      <div
        className="flex relative top-12  flex-wrap items-center justify-center"
        id="sportarea"
      >
